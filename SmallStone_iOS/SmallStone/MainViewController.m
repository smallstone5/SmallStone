...
- (void)viewDidLoad
{
    ...
    */
    ...
    [self.createGameButton setImage:[UIImage imageNamed:@"newgame.png"] forState:UIControlStateNormal];
    ...
    [self.continueButton setImage:[UIImage imageNamed:@"continue.png"] forState:UIControlStateNormal];
    ...
    [self.settingButton setImage:[UIImage imageNamed:@"setting.png"] forState:UIControlStateNormal];
    ...
    */
    ...
    self.levelButton.autoresizingMask = UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleBottomMargin;
    [self.ranknewButton setImage:[UIImage imageNamed:@"rank.png"] forState:UIControlStateNormal];
